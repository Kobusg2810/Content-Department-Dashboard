...
export function renderMoodleStats(stats, container, tickets) {
    ...
    container.innerHTML = `
        ...
        <div class="stat-card">
            ...
            <div class="stat-label">Avg. Resolution Time (All Time)</div>
        </div>

        <div class="stat-card">
            <div class="stat-header">
                <div class="stat-icon accent" style="background: linear-gradient(135deg, rgba(168, 85, 247, 0.2) 0%, rgba(168, 85, 247, 0.05) 100%); color: #a855f7;">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
